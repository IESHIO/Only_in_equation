...
int discriminant()
{
    ...
    else
    {
        ...
        { // При выборе 'y' происходит подсчёт мнимых корней
            ...
            x2 = -b - sqrt(D) / (2 * a);
            i = i / (2 * a);
            cout << "найденны корни: \nx1 = " << x1 << i << endl; // ОШИБКА nan! Неккоректный вывод x1 и x2, а также i
...
cin >> a11 >> a12 >> a13;                                                                                  
cin >> a21 >> a22 >> a23; 
cin >> a31 >> a32 >> a33;                                                                                  Только недавно (25.10.23) при тестирование квадратных уравнений я узнал, что этот отсек недоделан
